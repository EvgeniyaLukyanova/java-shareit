...
class ItemServiceImplIntegrationTest {
    ...
    void getItems() {
        ...
        assertEquals(itemDtoResponseList.get(0).getName(), item1.getName());
        assertEquals(itemDtoResponseList.get(0).getDescription(), item1.getDescription());
        assertEquals(itemDtoResponseList.get(0).getAvailable(), item1.getAvailable());
